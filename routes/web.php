...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/dashboard/admin/latest-markallread', [DashboardController::class, 'markAllRead'])->name('admin.notifications.markallread');
    ...
    Route::post('/dashboard/associate/candidateadd',[CandidateDetailsController::class, 'candidateStore'])->name('all.associate.add');
