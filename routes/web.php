...
Route::middleware(['allowedip', 'auth'])->group(function () {
    ...
    Route::get('/button/status', function () {
        return response()->json(['button_status' => 0]);
    })->name('button.status');
    Route::post('/dashboard/start-timer', function () {
        return response()->json(['success' => false]);
    })->name('timer.start');
    Route::post('/dashboard/start-timer-hide', function () {
        return response()->json(['exists' => true]);
    })->name('timer.starthide');
    Route::post('/dashboard/check-pause-buttons', function () {
        return response()->json(['pause_type' => null]);
    })->name('timer.checkPauseButtons');
    Route::post('/dashboard/check-pause-buttons-senior', function () {
        return response()->json(['pause_type' => null]);
    })->name('timer.checkPauseButtonsSenior');
    ...
    Route::get('/dashboard/senior/google-sheet-search', [GoogleSheetController::class, 'seniorsearch'])->name('google.sheet.seniorsearch');
    ...
    Route::get('/dashboard/senior/google-sheet-paidins', [GoogleSheetController::class, 'seniorpaidins'])->name('google.sheet.seniorpaidins');
    ...
    Route::get('/dashboard/senior/google-sheet/download-resume/{id}', [GoogleSheetController::class, 'downloadseniorResume'])->name('downloadseniorResume');
    ...
    Route::get('/dashboard/senior/google-sheet/search-tra-otp', [GoogleSheetController::class, 'seniortraotpSuggestions'])->name('seniortraotp.suggestions');
    ...
    Route::get('/dashboard/senior/google-sheet/seniorsearch', [GoogleSheetController::class, 'seniorsearchSuggestions'])->name('seniorsearch.suggestions');
    ...
    Route::get('/dashboard/junior/google-sheet-vm', [GoogleSheetController::class, 'juniorvm'])->name('google.sheet.juniorvm');
    ...
    Route::get('/dashboard/junior/google-sheet/download-resume/{id}', [GoogleSheetController::class, 'downloadjuniorResume'])->name('downloadjuniorResume');
    ...
    Route::get('/dashboard/trainer/google-sheet/download-resume/{id}', [GoogleSheetController::class, 'downloadtrainerResume'])->name('downloadtrainerResume');
    ...
    Route::get('/dashboard/accountant/google-sheet/download-resume/{id}', [GoogleSheetController::class, 'downloadaccountantResume'])->name('downloadaccountantResume');
    ...
    Route::get('/dashboard/neverreached/call-reports/export', [CallReportController::class, 'neverreachedExport'])->name('call.reports.neverreached.export');
    ...
    Route::get('/dashboard/target/allowedall', [DashboardController::class, 'allowedall'])->name('allowed.all');
    ...
    Route::get('/timer/all-juniors', function () {
        return response()->json([]);
    })->name('timer.alljuniors');
    Route::get('/dashboard/junior/juniortimer', [TimerController::class, 'juniorTimers'])->name('timer.junior');
    Route::post('/timer/toggle-button-status', function () {
        return response()->json(['success' => false, 'message' => 'Timer is disabled']);
    })->name('timer.toggleButtonStatus');
    Route::post('/timer/toggle-all-status', function () {
        return response()->json(['success' => false, 'message' => 'Timer is disabled']);
    })->name('timer.toggleAllStatus');
    ...
    Route::get('/timers/latest-pause-types', function () {
        return response()->json([]);
