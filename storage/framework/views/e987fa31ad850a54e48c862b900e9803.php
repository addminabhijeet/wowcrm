                        ...
                        <div class="row row-cols-xxxl-5 row-cols-lg-3 row-cols-sm-2 row-cols-1 gy-4">
                            ...
                            <div class="col">
                                <div class="card shadow-none border bg-gradient-end-3">
                                    <div class="card-body p-20">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                            <img src="<?php echo e(asset('assets/images/currency/crypto-img1.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                            ...
                            <div class="col">
                                <div class="card shadow-none border bg-gradient-end-1">
                                    <div class="card-body p-20">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                            <img src="<?php echo e(asset('assets/images/currency/crypto-img2.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                                            <div class="flex-grow-1">
                            ...
                            <div class="col">
                                <div class="card shadow-none border bg-gradient-end-5">
                                    <div class="card-body p-20">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                            <img src="<?php echo e(asset('assets/images/currency/crypto-img3.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                                            <div class="flex-grow-1">
                            ...
                            <div class="col">
                                <div class="card shadow-none border bg-gradient-end-6">
                                    <div class="card-body p-20">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                            <img src="<?php echo e(asset('assets/images/currency/crypto-img4.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                                            <div class="flex-grow-1">
                            ...
                            <div class="col">
                                <div class="card shadow-none border bg-gradient-end-3">
                                    <div class="card-body p-20">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                            <img src="<?php echo e(asset('assets/images/currency/crypto-img5.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                                            <div class="flex-grow-1">
                                        ...
                                        <div class="max-h-266-px overflow-y-auto scroll-sm pe-16">
                                            <div class="d-flex align-items-center justify-content-between gap-3 mb-12 pb-2">
                                                <div class="d-flex align-items-center w-100">
                                                    <img src="<?php echo e(asset('assets/images/flags/flag1.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12">
                                                    <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between gap-3 mb-12 pb-2">
                                                <div class="d-flex align-items-center w-100">
                                                    <img src="<?php echo e(asset('assets/images/flags/flag2.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12">
                                                    <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between gap-3 mb-12 pb-2">
                                                <div class="d-flex align-items-center w-100">
                                                    <img src="<?php echo e(asset('assets/images/flags/flag3.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12">
                                                    <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between gap-3 mb-12 pb-2">
                                                <div class="d-flex align-items-center w-100">
                                                    <img src="<?php echo e(asset('assets/images/flags/flag4.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12">
                                                    <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between gap-3 mb-12 pb-2">
                                                <div class="d-flex align-items-center w-100">
                                                    <img src="<?php echo e(asset('assets/images/flags/flag5.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12">
                                                    <div class="flex-grow-1">
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/widgets.blade.php ENDPATH**/ ?>