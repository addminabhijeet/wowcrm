<?php
$title='Add Senior Support Associate';
$role = auth()->user()->role ?? '';
if($role === 'admin'){
            ...
            <div class="col-xxl-6 col-xl-8 col-lg-10">
                <div class="card border">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('users.support.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-20">
                                ...
                                <select name="role" id="role" class="form-control radius-8 form-select" disabled>
                                    ...
                                    <option value="support" selected>Senior Support Associate</option>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/user/supportcreate.blade.php ENDPATH**/ ?>