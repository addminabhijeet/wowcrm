            ...
            <table class="table bordered-table sm-table mb-0">
                ...
                <tbody id="sheet-table-body">
                    ...
                    <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                        ...
                        <td>
                            <?php $exeOptions = ['Called & Mailed','Not Interested','Interested','Others','Ready To Pay','VM','Busy']; ?>
        ...
        tableBody.addEventListener('click', function(e) {
            if (e.target.matches('.save-btn') || e.target.closest('.save-btn')) {
                ...
                if (id === "new") {
                    ...
                    url = "<?php echo e(route('seniorupdatemod')); ?>";
                    method = "POST";
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/seniormod.blade.php ENDPATH**/ ?>