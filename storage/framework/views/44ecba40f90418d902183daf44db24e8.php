                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                        ...
                        <?php $__currentLoopData = $decoded; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($key === 'Exe Remarks'): ?>
                                <td>
                                    <select class="form-select dynamic-dropdown" data-key="<?php echo e($key); ?>">
                                        <?php $__currentLoopData = $exeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($option); ?>" <?php echo e($val === $option ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </td>

                            <?php elseif($key === 'Immigration'): ?>
                                <td>
                                    <select class="form-select dynamic-dropdown" data-key="<?php echo e($key); ?>">
                            ...
                            <?php elseif($key === '1st Follow Up Remarks'): ?>
                                <td>
                                    <select class="form-select dynamic-dropdown" data-key="<?php echo e($key); ?>">
                            ...
                            <?php elseif($key === 'View'): ?>
                            <td>
                                <input type="file" accept="application/pdf" class="d-none resume-input" data-key="<?php echo e($key); ?>">
                            ...
                            <?php elseif($key === 'Amount'): ?>
                                <td>
                                    <input type="text" class="form-control amount-input" data-key="<?php echo e($key); ?>" 
                                        value="<?php echo e($val ?? ''); ?>" placeholder="$100">
                                </td>

                            <?php elseif($key === 'Location'): ?>
                                <td>
                                    <input type="text" class="form-control location-autocomplete" data-key="<?php echo e($key); ?>" 
                                        value="<?php echo e($val ?? ''); ?>" placeholder="Type location (e.g. Aus or Delaw)">
                                </td>


                            
                            <?php elseif($key === 'Date' || $key === 'Graduation Date'): ?>
                                <td>
                                    <input type="text" class="form-control date-picker" data-key="<?php echo e($key); ?>" value="<?php echo e($val ?? ''); ?>">
                                </td>

                            
                            <?php elseif($key === 'Phone Number'): ?>
                                <td>
                                    <input type="tel" class="form-control phone-input" data-key="<?php echo e($key); ?>" maxlength="12" value="<?php echo e($val ?? ''); ?>" placeholder="US number">
                                    
                                </td>

                            
                            <?php elseif($key === 'Email Address'): ?>
                                <td>
                                    <input type="email" class="form-control email-input" data-key="<?php echo e($key); ?>" value="<?php echo e($val ?? ''); ?>" placeholder="E-mail">
                            ...
                            <?php elseif($key === 'Name'): ?>
                                <td>
                                    <input type="text" class="form-control name-input" data-key="<?php echo e($key); ?>" value="<?php echo e($val ?? ''); ?>" placeholder="Name">
                                    
                                </td>

                            
                            <?php elseif($key === 'Qualification'): ?>
                                <td>
                                    <input type="text" class="form-control qualification-input" data-key="<?php echo e($key); ?>" value="<?php echo e($val ?? ''); ?>" placeholder="Qualification">
    ...
    /* attach handlers & validations */
        ...
        btn.addEventListener("click", function () {
            ...
            fetch(url, {
                method: 'POST',
                headers: {
                    "X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>" // DO NOT set Content-Type for FormData
                },
                body: formData
            })
            .then(res => res.json())
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wowdash\resources\views\database\senior.blade.php ENDPATH**/ ?>