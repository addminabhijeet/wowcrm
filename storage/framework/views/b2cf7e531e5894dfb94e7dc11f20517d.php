                ...
                <div class="col-xxl-12">
                    <div class="card radius-12 shadow-none border overflow-hidden">
                        ...
                        <div class="card-body p-24">
                            ...
                            <form action="<?php echo e(route('smtp.addupdate')); ?>" method="POST" class="mb-5">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/smtp/add.blade.php ENDPATH**/ ?>