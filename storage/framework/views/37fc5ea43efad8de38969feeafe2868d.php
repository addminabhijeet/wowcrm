            ...
            <div class="card h-100 border-0 shadow-sm radius-12">
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
                        ...
                        <form method="GET" action="<?php echo e(route('call.reports.seniormonthly')); ?>"
                            ...
                            <input type="month" name="selected_month" id="selected_month"
                                value="<?php echo e(request('selected_month', date('Y-m'))); ?>" class="form-control form-control-sm"
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-2">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    ...
                                    <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($MfollowUpCalls); ?></h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    <small class="text-muted d-block">Self follow up</small>
                                    <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($MselffollowupCalls); ?></h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    <small class="text-muted d-block">Transfered Follow Up</small>
                                    <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($MtransferedfollowUpCalls); ?></h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    ...
                                    <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($MreadyToPaidCalls); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/reports/seniormonthly.blade.php ENDPATH**/ ?>