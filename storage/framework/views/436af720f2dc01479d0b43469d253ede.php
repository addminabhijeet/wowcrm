                            ...
                            <div class="mt-20 d-flex justify-content-center flex-wrap gap-3">
                                ...
                                <div class="d-inline-flex align-items-center gap-2 p-2 radius-8 border pe-36 br-hover-primary group-item">
                                    ...
                                    <div>
                                        ...
                                        <h6 class="text-md fw-semibold mb-0"><?php echo e($totalCalls); ?></h6>
                                    </div>
                                </div>
                                ...
                                <div class="d-inline-flex align-items-center gap-2 p-2 radius-8 border pe-36 br-hover-primary group-item">
                                    ...
                                    <div>
                                        ...
                                        <h6 class="text-md fw-semibold mb-0"><?php echo e($otherCalls); ?></h6>
                                    </div>
                                </div>
                                ...
                                <div class="d-inline-flex align-items-center gap-2 p-2 radius-8 border pe-36 br-hover-primary group-item">
                                    ...
                                    <div>
                                        ...
                                        <h6 class="text-md fw-semibold mb-0"><?php echo e($calledAndMailedCalls); ?></h6>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wowdash\resources\views/reports/junior.blade.php ENDPATH**/ ?>