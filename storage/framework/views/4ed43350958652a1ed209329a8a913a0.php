...
<div class="row gy-4">
    <div class="col-lg-4">
        <div class="user-grid-card position-relative border radius-16 overflow-hidden bg-base h-100" style="padding-top: 100px;">
            <img src="<?php echo e($user->image ? asset('assets/images/user-grid/' . $user->image) : asset('assets/images/user-grid/user-grid-bg1.png')); ?>" alt="" class="w-100 object-fit-cover">
            <div class="pb-24 ms-16 mb-24 me-16  mt--100">
                <div class="text-center border border-top-0 border-start-0 border-end-0">
                    <img src="<?php echo e($user->image ? asset('assets/images/user-grid/' . $user->image) : asset('assets/images/user-grid/user-grid-bg1.png')); ?>" alt="" class="border br-white border-width-2-px w-200-px h-200-px rounded-circle object-fit-cover">
                ...
                <div class="mt-24">
                    ...
                    <ul>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">: <?php echo e($user->role); ?></span>
                        </li>
                        <li class="d-flex align-items-center gap-1 mb-12">
                            <span class="w-30 text-md fw-semibold text-primary-light"> gender</span>
                            <span class="w-70 text-secondary-light fw-medium">: <?php echo e($user->gender); ?></span>
                        </li>
    ...
    <div class="col-lg-8">
        <div class="card h-100">
            <div class="card-body p-24">
                ...
                <form action="<?php echo e(route('users.admin.update', $user->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="role" id="role" class="form-control radius-8 form-select" required>
                                            ...
                                            <option value="senior" <?php echo e($user->role == 'senior' ? 'selected' : ''); ?>>IT Senior Recruiter</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="gender" id="gender" class="form-control radius-8 form-select" required>
                                            ...
                                            <option value="Senior" <?php echo e($user->gender == 'Senior' ? 'selected' : ''); ?>>IT Senior Recruiter</option>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/user/adminedit.blade.php ENDPATH**/ ?>