                    ...
                    <div class="col-xxl-3 col-md-6 user-grid-card">
                        <div class="position-relative border radius-16 overflow-hidden" style="padding-top: 30px;">
                            ...
                            <div class="ps-16 pb-16 pe-16 text-center mt--50">
                                <img src="<?php echo e($timer['image'] ? asset('assets/images/user-grid/' . $timer['image']) : asset('assets/images/user-grid/user-grid-bg1.png')); ?>"
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/timers/allsenior.blade.php ENDPATH**/ ?>