            ...
            <div class="card h-100 border-0 shadow-sm radius-12">
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
                        ...
                        <form method="GET"
                            action="<?php echo e(route('call.reports.alljuniorweekly', ['userId' => request()->route('userId')])); ?>"
                            ...
                            <input type="week"
                                name="selected_week"
                                id="selected_week"
                                value="<?php echo e(trim(request('selected_week', now()->format('Y-\WW')))); ?>"
                        ...
                        <div class="col-md-3">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    ...
                                    <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($StotalCalls); ?></h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    ...
                                    <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($SotherCalls); ?></h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    ...
                                    <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($ScalledAndMailedCalls); ?></h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    ...
                                    <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($Stotaltransfers); ?></h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-hover table-bordered align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center"><span class="badge bg-info"><?php echo e($t8to9am); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o8to9am); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-success"><?php echo e($tr8to9am); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="white-space: nowrap;">09.00AM-10.00AM</td>
                                    <td class="text-center"><span class="badge bg-info"><?php echo e($t9to10am); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o9to10am); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-success"><?php echo e($tr9to10am); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="white-space: nowrap;">10.00AM-11.00AM</td>
                                    <td class="text-center"><span class="badge bg-info"><?php echo e($t10to11am); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o10to11am); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-success"><?php echo e($tr10to11am); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="white-space: nowrap;">11.00AM-12.00PM</td>
                                    <td class="text-center"><span class="badge bg-info"><?php echo e($t11to12pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o11to12pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-success"><?php echo e($tr11to12pm); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="white-space: nowrap;">12.00PM-01.00PM</td>
                                    <td class="text-center"><span class="badge bg-info"><?php echo e($t12to1pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o12to1pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-success"><?php echo e($tr12to1pm); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="white-space: nowrap;">01.00PM-02.00PM</td>
                                    <td class="text-center"><span class="badge bg-info"><?php echo e($t1to2pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o1to2pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-success"><?php echo e($tr1to2pm); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="white-space: nowrap;">02.00PM-03.00PM</td>
                                    <td class="text-center"><span class="badge bg-info"><?php echo e($t2to3pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o2to3pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-success"><?php echo e($tr2to3pm); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="white-space: nowrap;">03.00PM-04.00PM</td>
                                    <td class="text-center"><span class="badge bg-info"><?php echo e($t3to4pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o3to4pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-success"><?php echo e($tr3to4pm); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="white-space: nowrap;">04.00PM-05.00PM</td>
                                    <td class="text-center"><span class="badge bg-info"><?php echo e($t4to5pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o4to5pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-success"><?php echo e($tr4to5pm); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="white-space: nowrap;">05.00PM-06.00PM</td>
                                    <td class="text-center"><span class="badge bg-info"><?php echo e($t5to6pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o5to6pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-success"><?php echo e($tr5to6pm); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="white-space: nowrap;">06.00PM-07.00PM</td>
                                    <td class="text-center"><span class="badge bg-info"><?php echo e($t6to7pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o6to7pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-success"><?php echo e($tr6to7pm); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="white-space: nowrap;">07.00PM-08.00PM</td>
                                    <td class="text-center"><span class="badge bg-info"><?php echo e($t7to8pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o7to8pm); ?></span>
                                    </td>
                                    <td class="text-center"><span class="badge bg-success"><?php echo e($tr7to8pm); ?></span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/reports/alljuniorweekly.blade.php ENDPATH**/ ?>