    ...
    <table class="table bordered-table sm-table mb-0" id="sheet-table">
        ...
        <tbody id="sheet-table-body">
            ...
            <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                ...
                <td>
                    <textarea class="form-control rejectedremark-autocomplete" rows="6" placeholder="Type rejected remark"><?php echo e($row->RejectedRemark ?? ''); ?></textarea>
                ...
                <td class="text-center">
                    ...
                    <button class="btn btn-sm btn-warning rejected-btn" data-id="<?php echo e($row->id); ?>">
...
<?php endif; ?>
</div><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/partials/seniortraotp_table.blade.php ENDPATH**/ ?>