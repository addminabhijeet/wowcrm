        ...
        <div class="d-flex align-items-center flex-wrap gap-3">
            ...
            <select class="form-select form-select-sm w-auto ps-12 py-6 radius-12 h-40-px" name="junior_user"
                ...
                <option value="<?php echo e($junior->id); ?>">
                    <?php echo e($junior->name); ?> <?php echo e($junior->gender ? '(' . $junior->gender . ')' : ''); ?>
...
<script>
    $(document).ready(function() {
        ...
        function fetchTable(search = '', page = 1, junior_user = '', row_id = '', date = '') {
            $.ajax({
                url: "<?php echo e(route('google.sheet.seniorfollow')); ?>",
                type: 'GET',
                data: {
                    search,
                    page,
        ...
        const showSuggestions = debounce(function() {
            ...
            $.ajax({
                url: "<?php echo e(route('seniorfollow.suggestions')); ?>",
                type: 'GET',
                data: {
                    query,
                    junior_user
...
<script>
    $(document).on("click", ".transfers-btn", function() {
        ...
        $.ajax({
            url: "<?php echo e(route('junior.transfers.update')); ?>",
            method: "POST",
            data: {
                id: id,
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/seniorfollow.blade.php ENDPATH**/ ?>