...
<?php $__env->startSection('content'); ?>
                        ...
                        <tbody id="sheet-table-body">
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                                    ...
                                    <td>
                                        <?php $exeOptions = ['Training Completed','Not Interested','Not Connected','Did Not Pickup','Others','Payment Completed','VM','Busy']; ?>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            tableBody.addEventListener('click', function(e) {
                if (e.target.matches('.save-btn') || e.target.closest('.save-btn')) {
                    ...
                    let url, method;
                    if (id === "new") {
                        url = "<?php echo e(route('trainerstore')); ?>";
                        method = "POST";
                    } else {
                        url = "<?php echo e(route('trainerupdate')); ?>";
                        method = "POST";
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchTable(search = '', page = 1, junior_user = '', row_id = '') {
                $.ajax({
                    url: "<?php echo e(route('google.sheet.trainer')); ?>",
                    type: 'GET',
                    data: {
                        search,
                        page,
            ...
            const showSuggestions = debounce(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('trainer.suggestions')); ?>",
                    type: 'GET',
                    data: {
                        query
                    },
    ...
    <script>
        document.getElementById('junior-filter').addEventListener('change', function() {
            ...
            fetch("<?php echo e(route('google.sheet.trainer')); ?>?junior_user=" + juniorId + "&search=" + search, {
                    headers: {
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/trainercomplete.blade.php ENDPATH**/ ?>