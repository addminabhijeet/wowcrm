        ...
        <div class="card h-100 p-0">
            <div class="card-body p-24">
                ...
                <div class="d-flex flex-wrap align-items-center gap-1 justify-content-between mb-16">
                    ...
                    <a  href="<?php echo e(route('users.senior.create')); ?>" class="btn btn-primary text-sm btn-sm px-12 py-12 radius-8 d-flex align-items-center gap-2">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex align-items-center gap-10 justify-content-center">
                                                <a href="<?php echo e(route('users.senior.editgroup', $user->id)); ?>" class="bg-success-focus text-success-600 bg-hover-success-200 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle">
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/user/seniorgroup.blade.php ENDPATH**/ ?>