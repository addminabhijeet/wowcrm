                        ...
                        <div class="card-body p-0">
                            <div class="py-16 px-24 border-bottom">
                                <div class="d-flex align-items-start gap-3">
                                    <img src="<?php echo e(asset('assets/images/user-list/user-list1.png')); ?>" alt="" class="w-40-px h-40-px rounded-pill">
                                    <div class="">
                            ...
                            <div class="py-16 px-24 border-bottom">
                                <div class="d-flex align-items-start gap-3">
                                    <img src="<?php echo e(asset('assets/images/user-list/user-list2.png')); ?>" alt="" class="w-40-px h-40-px rounded-pill">
                                    <div class="">
                                        <div class="d-flex align-items-center flex-wrap gap-2">
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/veiwDetails.blade.php ENDPATH**/ ?>