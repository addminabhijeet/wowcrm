                ...
                <div class="card h-100 border-0 shadow-sm radius-12">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
                            ...
                            <form method="GET"
                                action="<?php echo e(route('call.reports.preallseniorweekly', ['userId' => request()->route('userId')])); ?>"
                                ...
                                <input type="week" name="selected_week" id="selected_week"
                            ...
                            <div class="col-md-2">
                                <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($SfollowUpCalls); ?></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($SselffollowupCalls); ?></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($StransferedfollowUpCalls); ?></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($SreadyToPaidCalls); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/reports/preallseniorweekly.blade.php ENDPATH**/ ?>