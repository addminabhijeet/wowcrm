                        ...
                        <div class="card-body p-20">
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                <div>
                                    ...
                                    <h6 class="mb-0"><?php echo e($users->where('role', 'customer')->count()); ?></h6>
                                </div>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wowdash\resources\views\dashboard\accountant.blade.php ENDPATH**/ ?>