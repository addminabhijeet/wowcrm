...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card h-100 p-0 radius-12">
        ...
        <div class="card-body p-24" id="senior-table-wrapper">
                                ...
                                <tr class="text-nowrap small">
                                    ...
                                    <td class="px-1 py-1">
                                        <input type="text" class="form-control form-control-sm p-1 name-input"
                                            data-key="Name" value="<?php echo e($row->Name ?? ''); ?>">
                                    </td>
                                    ...
                                    <td class="px-1 py-1">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="tel" class="form-control p-1 phone-input"
                                                data-key="Phone Number" value="<?php echo e($row->Phone_Number ?? ''); ?>">
                                        </div>
                                    </td>
            ...
            <?php if(method_exists($data, 'hasPages') && $data->hasPages()): ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchTable(search = '', page = 1, junior_user = '', row_id = '', show_all = false) {
                $.ajax({
                    url: "<?php echo e(route('google.sheet.seniorsearch')); ?>",
                    data: {
                        search,
                        page,
                        junior_user,
            ...
            const showSuggestions = debounce(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('seniorsearch.suggestions')); ?>",
                    data: {
                        query,
                        junior_user
                    },
    ...
    <script>
        document.getElementById('junior-filter').addEventListener('change', function() {
            ...
            fetch("<?php echo e(route('google.sheet.seniorsearch')); ?>?junior_user=" + juniorId + "&search=" + search, {
                    headers: {
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/seniorsearch.blade.php ENDPATH**/ ?>