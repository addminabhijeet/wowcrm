                                ...
                                <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                                    ...
                                    <td>
                                        <input type="text" class="form-control date-picker" data-key="PaymentDate"
                                            value="<?php echo e($row->PaymentDate ? \Carbon\Carbon::parse($row->PaymentDate)->format('m/d/Y') : ''); ?>">
                                    </td>

                                    
                                    <td>
                                        <input type="text" class="form-control" data-key="TranId"
                                            value="<?php echo e($row->TranId ?? ''); ?>" placeholder="Account No">
                                    </td>

                                    
                                    <td>
                                        <input type="text" class="form-control" data-key="TranRef"
                                            value="<?php echo e($row->TranRef ?? ''); ?>" placeholder="Reference Number">
                                    </td>

                                    
                                    <td>
                                        <input type="text" class="form-control" data-key="PaymentMethod"
                                            value="<?php echo e($row->PaymentMethod ?? ''); ?>" placeholder="Payment Method">
                                    </td>

                                    
                                    <td>
                                        <input type="text" class="form-control" data-key="PayeeName"
                                            value="<?php echo e($row->PayeeName ?? ''); ?>" placeholder="Payer Name">
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-info upload-acceptance-btn">
                                            <?php echo e(!empty($row->acceptance) ? 'Change File' : 'Upload'); ?>

                                        </button>

                                        <?php if(!empty($row->acceptance)): ?>
                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/view-acceptance/' . $row->id)); ?>"
                                                target="_blank" class="btn btn-sm btn-primary viewacceptance-btn">View
                                                Acceptance</a>

                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/download-acceptance/' . $row->id)); ?>"
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-info upload-delivery-btn">
                                            <?php echo e(!empty($row->delivery) ? 'Change File' : 'Upload'); ?>

                                        </button>

                                        <?php if(!empty($row->delivery)): ?>
                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/view-delivery/' . $row->id)); ?>"
                                                target="_blank" class="btn btn-sm btn-primary viewdelivery-btn">View
                                                Delivery</a>

                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/download-delivery/' . $row->id)); ?>"
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-info upload-payment-btn">
                                            <?php echo e(!empty($row->payment) ? 'Change File' : 'Upload'); ?>

                                        </button>

                                        <?php if(!empty($row->payment)): ?>
                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/view-payment/' . $row->id)); ?>"
                                                target="_blank" class="btn btn-sm btn-primary viewpayment-btn">View
                                                Payment</a>

                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/download-payment/' . $row->id)); ?>"
                                    ...
                                    <td>
                                        <input type="text" class="form-control forwardedBy-input"
                                            data-key="forwardedBy" value="<?php echo e($row->forwarded_by ?? ''); ?>"
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-info upload-acceptancesign-btn">
                                            <?php echo e(!empty($row->acceptancesign) ? 'Change File' : 'Upload'); ?>

                                        </button>

                                        <?php if(!empty($row->acceptancesign)): ?>
                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/view-acceptancesign/' . $row->id)); ?>"
                                                target="_blank" class="btn btn-sm btn-primary viewacceptancesign-btn">View
                                                Acceptance Sign</a>

                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/download-acceptancesign/' . $row->id)); ?>"
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-info upload-deliverysign-btn">
                                            <?php echo e(!empty($row->deliverysign) ? 'Change File' : 'Upload'); ?>

                                        </button>

                                        <?php if(!empty($row->deliverysign)): ?>
                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/view-deliverysign/' . $row->id)); ?>"
                                                target="_blank" class="btn btn-sm btn-primary viewdeliverysign-btn">View
                                                Delivery Sign</a>

                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/download-deliverysign/' . $row->id)); ?>"
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-info upload-paymentsign-btn">
                                            <?php echo e(!empty($row->paymentsign) ? 'Change File' : 'Upload'); ?>

                                        </button>

                                        <?php if(!empty($row->paymentsign)): ?>
                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/view-paymentsign/' . $row->id)); ?>"
                                                target="_blank" class="btn btn-sm btn-primary viewpaymentsign-btn">View
                                                Payment Sign</a>

                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/download-paymentsign/' . $row->id)); ?>"
                                    ...
                                    <td>
                                        ...
                                        <?php if(!empty($row->resume)): ?>
                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/view-resume/' . $row->id)); ?>"
                                                target="_blank" class="btn btn-sm btn-primary view-btn">View PDF</a>
                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/download-resume/' . $row->id)); ?>"
                                    ...
                                    <td>
                                        <textarea class="form-control remark-autocomplete" data-key="Remark" placeholder="Type remark" rows="6"><?php echo e($row->Remark ?? ''); ?></textarea>
                                    </td>

                                    
                                    <td>
                                        <?php $exeOptions = ['Document Send','Document Verified']; ?>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            tableBody.addEventListener('click', function(e) {
                if (e.target.matches('.generate-btn') || e.target.closest('.generate-btn')) {
                    ...
                    const senderEmail = "<?php echo e(auth()->user()->email); ?>";
...
">
    ...
    ">
        ...
        <div style="background:#fff; padding:18px; border-radius:12px; max-width:1010px;
            ...
            <iframe
                src="<?php echo e(route('pdf.acceptance')); ?>?${queryParams}"
        ...
        <div style="background:#fff; padding:18px; border-radius:12px; max-width:1010px;
            ...
            <iframe
                src="<?php echo e(route('pdf.consultation')); ?>?${queryParams}"
                style="width:100%; height:1270px; border:0; border-radius:10px;">
            </iframe>
        </div>
        ...
        <div style="background:#fff; padding:18px; border-radius:12px; max-width:1010px;
            ...
            <iframe
                src="<?php echo e(route('pdf.delivery')); ?>?${queryParams}"
                style="width:100%; height:1270px; border:0; border-radius:10px;">
            </iframe>
        </div>
        ...
        <div style="background:#fff; padding:18px; border-radius:12px; max-width:1010px;
            ...
            <iframe
                src="<?php echo e(route('pdf.payment')); ?>?${queryParams}"
                style="width:100%; height:1270px; border:0; border-radius:10px;">
            </iframe>
        </div>
        ...
        `;
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            const pdfUrls = [
                                `<?php echo e(route('pdf.acceptance')); ?>?${queryParams}`,
                                `<?php echo e(route('pdf.consultation')); ?>?${queryParams}`,
                                `<?php echo e(route('pdf.delivery')); ?>?${queryParams}`,
                                `<?php echo e(route('pdf.payment')); ?>?${queryParams}`
                            ];
                            ...
                            Promise.all(
                                ...
                                .then(blobs => {
                                    ...
                                    pdfForm.append("_token", "<?php echo e(csrf_token()); ?>");
            ...
            tableBody.addEventListener('click', function(e) {
                if (e.target.matches('.save-btn') || e.target.closest('.save-btn')) {
                    ...
                    let url, method;
                    if (id === "new") {
                        url = "<?php echo e(route('accountantstore')); ?>";
                        method = "POST";
                    } else {
                        url = "<?php echo e(route('accountantupdatever')); ?>";
                        method = "POST";
                        formData.append("id", id);
                    }
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchTable(search = '', page = 1, junior_user = '', row_id = '') {
                $.ajax({
                    url: "<?php echo e(route('google.sheet.accountant')); ?>",
                    type: 'GET',
                    data: {
                        search,
                        page,
            ...
            const showSuggestions = debounce(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('accountant.suggestions')); ?>",
                    type: 'GET',
                    data: {
                        query
                    },
    ...
    <script>
        document.getElementById('junior-filter').addEventListener('change', function() {
            ...
            fetch("<?php echo e(route('google.sheet.accountant')); ?>?junior_user=" + juniorId + "&search=" + search, {
                    headers: {
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/accountantver.blade.php ENDPATH**/ ?>