                    ...
                    <ul>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">
                                : <?php echo e($user->role === 'writer' ? 'Resume Writer' : $user->role); ?>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">: <?php echo e($user->gender === 'Writer' ? 'Resume Writer' : $user->gender); ?></span>
                        </li>
    ...
    <div class="col-lg-8">
        <div class="card h-100">
            <div class="card-body p-24">
                ...
                <form action="<?php echo e(route('users.writer.update', $user->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="role" id="role" class="form-control radius-8 form-select" required>
                                            ...
                                            <option value="writer" <?php echo e($user->role == 'writer' ? 'selected' : ''); ?>>Resume Writer</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="gender" id="gender" class="form-control radius-8 form-select" required>
                                            ...
                                            <option value="Writer" <?php echo e($user->gender == 'Writer' ? 'selected' : ''); ?>>Resume Writer</option>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/user/writeredit.blade.php ENDPATH**/ ?>