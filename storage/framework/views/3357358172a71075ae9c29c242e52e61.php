...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchTable(search = '', page = 1, junior_user = '', row_id = '') {
                $.ajax({
                    url: "<?php echo e(route('google.sheet.career')); ?>",
                    type: 'GET',
                    data: {
                        search,
                        page,
            ...
            const showSuggestions = debounce(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('career.suggestions')); ?>",
                    type: 'GET',
                    data: {
                        query
                    },
    ...
    <script>
        document.getElementById('junior-filter').addEventListener('change', function() {
            ...
            fetch("<?php echo e(route('google.sheet.career')); ?>?junior_user=" + juniorId + "&search=" + search, {
                    headers: {
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/career.blade.php ENDPATH**/ ?>