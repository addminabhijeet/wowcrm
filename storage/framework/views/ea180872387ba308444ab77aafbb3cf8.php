                ...
                <div class="card h-100 border-0 shadow-sm"
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center p-4">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold" style="font-size: 25px;">$<?php echo e($targetGiven); ?></h3>
                        </div>
                ...
                <div class="card h-100 border-0 shadow-sm"
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center p-4">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold" style="font-size: 25px;">$<?php echo e($targetAchieved); ?></h3>
                        </div>
                        <div class="d-flex justify-content-center align-items-center"
                ...
                <div class="card h-100 border-0 shadow-sm"
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center p-4">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold" style="font-size: 25px;">$<?php echo e($targetYetToAchieve); ?></h3>
                        </div>
                        <div class="d-flex justify-content-center align-items-center"
                ...
                <div class="card h-100 border-0 shadow-sm"
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center p-4">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold" style="font-size: 25px;"><?php echo e($daysLeft); ?></h3>
                        </div>
                        <div class="d-flex justify-content-center align-items-center"
                ...
                <div class="card h-100 border-0 shadow-sm"
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center p-4">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold" style="font-size: 25px;"><?php echo e($presentDays); ?></h3>
                        </div>
                        <div class="d-flex justify-content-center align-items-center"
                            style="width: 70px; height: 70px; background-color: rgba(46,125,50,0.1); border-radius: 50%;">
                ...
                <div class="card h-100 border-0 shadow-sm"
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center p-4">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold" style="font-size: 25px;"><?php echo e($absentDays); ?></h3>
                        </div>
                        <div class="d-flex justify-content-center align-items-center"
                ...
                <div class="card h-100 border-0 shadow-sm"
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center p-4">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold" style="font-size: 25px;"><?php echo e($workingDays); ?></h3>
                        </div>
                        <div class="d-flex justify-content-center align-items-center"
                            style="width: 70px; height: 70px; background-color: rgba(239,108,0,0.1); border-radius: 50%;">
                ...
                <div class="card h-100 border-0 shadow-sm radius-12">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
                            ...
                            <form method="GET"
                                action="<?php echo e(route('call.reports.alljuniormonthly', ['userId' => request()->route('userId')])); ?>"
                            ...
                            <div class="col-md-2 col-sm-4 col-6">
                                <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($MtotalCalls); ?></h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-4 col-6">
                                <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($MotherCalls); ?></h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-4 col-6">
                                <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($McalledAndMailedCalls); ?></h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-4 col-6">
                                <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($MAvgTotalCalls); ?></h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-4 col-6">
                                <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($Mtotaltransfers); ?></h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-4 col-6">
                                <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-dark mb-0 fs-3"><?php echo e($MAvgtotaltransfers); ?></h4>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay1); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay1); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay1); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>02</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay2); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay2); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay2); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>03</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay3); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay3); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay3); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>04</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay4); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay4); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay4); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>05</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay5); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay5); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay5); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>06</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay6); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay6); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay6); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>07</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay7); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay7); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay7); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>08</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay8); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay8); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay8); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>09</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay9); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay9); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay9); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>10</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay10); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay10); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay10); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>11</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay11); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay11); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay11); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>12</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay12); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay12); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay12); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>13</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay13); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay13); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay13); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>14</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay14); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay14); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay14); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>15</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay15); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay15); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay15); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>16</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay16); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay16); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay16); ?></span></td>
                                            </tr>
                                    ...
                                    <table class="table table-hover table-bordered align-middle mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>17</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay17); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay17); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay17); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>18</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay18); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay18); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay18); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>19</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay19); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay19); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay19); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>20</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay20); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay20); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay20); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>21</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay21); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay21); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay21); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>22</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay22); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay22); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay22); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>23</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay23); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay23); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay23); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>24</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay24); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay24); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay24); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>25</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay25); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay25); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay25); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>26</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay26); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay26); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay26); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>27</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay27); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay27); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay27); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>28</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay28); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay28); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay28); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>29</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay29); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay29); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay29); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>30</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay30); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay30); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay30); ?></span></td>
                                            </tr>

                                            <tr>
                                                <td>31</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($tDay31); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($oDay31); ?></span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($trDay31); ?></span></td>
                                            </tr>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/reports/alljuniormonthly.blade.php ENDPATH**/ ?>