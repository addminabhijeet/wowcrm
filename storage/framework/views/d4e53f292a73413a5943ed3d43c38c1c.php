...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const timerStartUrl = "<?php echo e(route('timer.start')); ?>";
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const timerStartHideUrl = "<?php echo e(route('timer.starthide')); ?>";
        const csrfToken = "<?php echo e(csrf_token()); ?>";
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Assign Blade outputs to JS variables
        const checkPauseButtonsUrl = "<?php echo e(route('timer.checkPauseButtons')); ?>";
        const csrfToken = "<?php echo e(csrf_token()); ?>";
...
</script><?php /**PATH C:\xampp\htdocs\wowcrm\resources\views/components/navbar.blade.php ENDPATH**/ ?>