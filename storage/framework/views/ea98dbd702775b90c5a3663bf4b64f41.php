    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchTable(search = '', page = 1, junior_user = '', row_id = '', date = '') {
                ...
                activeRequest = $.ajax({
                    url: "<?php echo e(route('google.sheet.junior')); ?>",
                    type: 'GET',
                    data: {
                        search: search,
                        page: page,
            ...
            const showSuggestions = debounce(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('junior.suggestions')); ?>",
                    type: 'GET',
                    data: {
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/juniorother.blade.php ENDPATH**/ ?>