        ...
        <div class="chat-main card overflow-hidden">
            ...
            <div class="chat-message-list max-h-612-px min-h-612-px position-relative">
                <div class="d-flex align-items-center justify-content-center flex-column h-100 position-absolute top-50 start-50 translate-middle">
                    <img src="<?php echo e(asset('assets/images/chatgpt/empty-message-icon1.png')); ?>" alt="">
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/aiapplication/textGeneratorNew.blade.php ENDPATH**/ ?>