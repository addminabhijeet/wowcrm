...
<script>
    $(document).ready(function() {
        ...
        function fetchTable({
            ...
            $.ajax({
                url: "<?php echo e(route('google.sheet.seniortrafollow')); ?>",
                type: "GET",
                data: {
                    search,
                    page,
        ...
        const loadSuggestions = debounce(function() {
            ...
            $.ajax({
                url: "<?php echo e(route('seniortrafollow.suggestions')); ?>",
                type: "GET",
                data: {
                    query: query,
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/seniortrafollow.blade.php ENDPATH**/ ?>