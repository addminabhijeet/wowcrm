        ...
        <div class="col-xxl-3 col-lg-4">
            <div class="card h-100 p-0">
                <div class="card-body p-0">
                    <div class="p-24">
                    <a  href="<?php echo e(route('textGeneratorNew')); ?>" class="btn btn-primary text-sm btn-sm px-12 py-12 w-100 radius-8 d-flex align-items-center justify-content-center gap-2">
                    ...
                    <ul class="ai-chat-list scroll-sm pe-24 ps-24 pb-24">
                        ...
                        <li class="mb-16">
                            <a  href="<?php echo e(route('textGenerator')); ?>" class="text-line-1 text-secondary-light text-hover-primary-600">UI/UX Design Roadmap write me the roadmap right now </a>
                        </li>
                        <li class="mb-16">
                            <a  href="<?php echo e(route('textGenerator')); ?>" class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
                        <li class="mb-16">
                            <a  href="<?php echo e(route('textGenerator')); ?>" class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
                        ...
                        <li class="mb-16">
                            <a  href="<?php echo e(route('textGenerator')); ?>" class="text-line-1 text-secondary-light text-hover-primary-600">Online School Education Learning</a>
                        </li>
                        <li class="mb-16">
                            <a  href="<?php echo e(route('textGenerator')); ?>" class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
        ...
        <div class="col-xxl-9 col-lg-8">
            <div class="chat-main card overflow-hidden">
                <div class="chat-sidebar-single gap-8 justify-content-between cursor-default flex-nowrap">
                    ...
                    <a  href="<?php echo e(route('textGeneratorNew')); ?>" class="text-primary-light text-2xl line-height-1"><i class="ri-arrow-left-line"></i></a>
                ...
                <div class="chat-message-list max-h-612-px min-h-612-px">
                    ...
                    <div class="d-flex align-items-start justify-content-between gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                        <div class="d-flex align-items-center gap-16">
                            <div class="img overflow-hidden flex-shrink-0">
                                <img src="<?php echo e(asset('assets/images/chat/1.png')); ?>" alt="image" class="w-44-px h-44-px rounded-circle object-fit-cover">
                            </div>
                    ...
                    <div class="d-flex align-items-start gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                        <div class="img overflow-hidden flex-shrink-0">
                            <img src="<?php echo e(asset('assets/images/wow-dash-favicon.png')); ?>" alt="image" class="w-44-px h-44-px rounded-circle object-fit-cover">
                        </div>
                        <div class="info flex-grow-1">
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/aiapplication/textGenerator.blade.php ENDPATH**/ ?>