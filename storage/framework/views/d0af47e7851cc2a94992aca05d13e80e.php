    ...
    <div class="col-12">
        <div class="card h-100">
            <div class="card-body p-24">
                <form action="<?php echo e(route('users.seniorgroupmail.update', $user->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="mail[]" id="junior" class="form-control radius-8 form-select" required>
                                            ...
                                            <?php if(!in_array($junior->id, $user->mail ?? [])): ?>
                        ...
                        <div class="row">
                            <div class="col-12 mt-3">
                                ...
                                <div class="d-flex justify-content-between align-items-center border p-2 mb-2 radius-8">
                                    ...
                                    <form action="<?php echo e(route('users.seniorgroupmail.remove', [$user->id, $junior->id])); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/user/senioreditgroupmail.blade.php ENDPATH**/ ?>