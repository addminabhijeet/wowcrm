                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
                        ...
                        <form method="GET"
                            ...
                            <input type="date" name="selected_date" id="selected_date"
                                value="<?php echo e(request('selected_date', date('Y-m-d'))); ?>" class="form-control form-control-sm"
                        ...
                        <table class="table table-hover table-bordered align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center"><span class="badge bg-light"><?php echo e($t8to9am); ?></span></td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o8to9am); ?></span></td>
                                </tr>
                                <tr>
                                    <td style="white-space: nowrap;">09.00AM-10.00AM</td>
                                    <td class="text-center"><span class="badge bg-light"><?php echo e($t9to10am); ?></span></td>
                                    <td class="text-center"><span class="badge bg-warning"><?php echo e($o9to10am); ?></span></td>
                                </tr>
                                <tr>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/reports/allaccountantdaily.blade.php ENDPATH**/ ?>