    ...
    <div class="chat-wrapper">
        <div class="chat-sidebar profile-setting card">
            ...
            <div class="chat-main-profile">
                <div class="img">
                    <img src="<?php echo e(asset('assets/images/chat/chat-main.png')); ?>" alt="image">
                </div>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/chatProfile.blade.php ENDPATH**/ ?>