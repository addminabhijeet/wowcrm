        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            tableBody.addEventListener('click', function(e) {
                if (e.target.matches('.save-btn') || e.target.closest('.save-btn')) {
                    ...
                    let url = "<?php echo e(route('juniorcandmupdate')); ?>";
                    let method = "POST";
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchTable(search = '', page = 1, junior_user = '', row_id = '', date = '') {
                ...
                activeRequest = $.ajax({
                    url: "<?php echo e(route('google.sheet.junior.candm')); ?>",
                    type: 'GET',
                    data: {
                        search: search,
                        page: page,
            ...
            const showSuggestions = debounce(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('juniorcandm.suggestions')); ?>",
                    type: 'GET',
                    data: {
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/juniorcandm.blade.php ENDPATH**/ ?>