                                ...
                                <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                                    ...
                                    <td>
                                        <input type="text" class="form-control name-input" data-key="Name"
                                            value="<?php echo e($row->Name ?? ''); ?>" placeholder="Name" readonly>
                                    </td>

                                    
                                    <td>
                                        <input type="email" class="form-control email-input" data-key="Email Address"
                                            value="<?php echo e($row->Email_Address ?? ''); ?>" placeholder="E-mail" readonly>
                                    </td>
                                    ...
                                    <td>
                                        <input type="text" class="form-control location-autocomplete" data-key="Location"
                                            value="<?php echo e($row->Location ?? ''); ?>" placeholder="Type location" readonly>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="Qualification" value="<?php echo e($row->Qualification); ?>">
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-info upload-updateresume-btn">
                                            <?php echo e(!empty($row->updateresume) ? 'Change File' : 'Upload'); ?>

                                        </button>

                                        <?php if(!empty($row->updateresume)): ?>
                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/view-updateresume/' . $row->id)); ?>"
                                                target="_blank" class="btn btn-sm btn-primary viewupdateresume-btn">View
                                                Updated Resume</a>

                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/download-updateresume/' . $row->id)); ?>"
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="Exe_Remarks" value="<?php echo e($row->Exe_Remarks); ?>">
                                    </td>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            tableBody.addEventListener('click', function(e) {
                if (e.target.matches('.save-btn') || e.target.closest('.save-btn')) {
                    ...
                    let url, method;
                    if (id === "new") {
                        url = "<?php echo e(route('writterupdate')); ?>";
                        method = "POST";
                    } else {
                        url = "<?php echo e(route('writterupdate')); ?>";
                        method = "POST";
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/writer.blade.php ENDPATH**/ ?>