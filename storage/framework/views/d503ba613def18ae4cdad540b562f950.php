                        ...
                        <div class="card-body p-24">
                            <ul class="d-flex flex-wrap align-items-center gap-20 mt-20">
                                <li class="text-secondary-light border radius-4 px-8 py-4 text-sm line-height-1 fw-medium d-flex align-items-center gap-1">
                                    <img src="<?php echo e(asset('assets/images/flags/flag-tag.png')); ?>" class="w-16-px h-16-px rounded-circle" alt="">
                                    Label
                                </li>
                                <li class="text-secondary-light border radius-4 px-8 py-4 text-sm line-height-1 fw-medium d-flex align-items-center gap-1">
                                    <img src="<?php echo e(asset('assets/images/flags/flag-tag.png')); ?>" class="w-16-px h-16-px rounded-circle" alt="">
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/componentspage/tags.blade.php ENDPATH**/ ?>