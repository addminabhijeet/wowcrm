    ...
    <section class="auth bg-base d-flex flex-wrap">
        ...
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                <div>
                    <a href="<?php echo e(route('index')); ?>" class="mb-40 max-w-290-px">
                ...
                <form action="#">
                    ...
                    <div class="mt-32 text-center text-sm">
                        <p class="mb-0">Don’t have an account?<a  href="<?php echo e(route('signup')); ?>" class="text-primary-600 fw-semibold">Sign Up</a></p>
                    </div>
...
</html><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/authentication/signin.blade.php ENDPATH**/ ?>