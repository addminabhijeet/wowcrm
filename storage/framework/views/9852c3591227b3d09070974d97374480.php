...
<script>
    $(document).ready(function() {
        ...
        function fetchTable(search = '', page = 1, junior_user = '', row_id = '') {
            $.ajax({
                url: "<?php echo e(route('google.sheet.seniorcandm')); ?>",
                data: {
                    search,
                    page,
                    junior_user,
        ...
        const showSuggestions = debounce(function() {
            ...
            $.ajax({
                url: "<?php echo e(route('seniorcandm.suggestions')); ?>",
                data: {
                    query,
                    junior_user
                },
...
<script>
    document.getElementById('junior-filter').addEventListener('change', function() {
        ...
        fetch("<?php echo e(route('google.sheet.seniorcandm')); ?>?junior_user=" + juniorId + "&search=" + search, {
                headers: {
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/seniorcandm.blade.php ENDPATH**/ ?>