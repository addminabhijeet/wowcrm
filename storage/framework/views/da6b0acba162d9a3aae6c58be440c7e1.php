                ...
                <select class="form-select form-select-sm w-auto ps-12 py-6 radius-12 h-40-px" name="junior_user"
                    ...
                    <?php $__currentLoopData = $juniorUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $junior): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($junior->id); ?>">
                            ...
                            <?php if($junior->role): ?>
                                (<?php echo e($junior->role === 'senior' ? 'IT Senior Recruiter' : ($junior->role === 'junior' ? 'IT Recruiter' : $junior->role)); ?>)
                            <?php endif; ?>
                        </option>
                                    ...
                                    <td>
                                        ...
                                        <select class="form-select dynamic-dropdown" data-key="Remarks">
                                            ...
                                            <?php $__currentLoopData = $exeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($option); ?>"
                                                    <?php echo e($row->Exe_RemarStatusks === $option ? 'selected' : ''); ?>>
                                                    <?php echo e($option); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchTable(search = '', page = 1, junior_user = '', row_id = '') {
                $.ajax({
                    url: "<?php echo e(route('google.sheet.index')); ?>",
                    type: 'GET',
                    data: {
                        search,
                        page,
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/admin.blade.php ENDPATH**/ ?>