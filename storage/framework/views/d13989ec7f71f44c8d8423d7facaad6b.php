                                ...
                                <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                                    ...
                                    <td>
                                        <input type="text" class="form-control" data-key="TranId"
                                            value="<?php echo e($row->TranId ?? ''); ?>" placeholder="Transaction ID">
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-info upload-consultation-btn">
                                            <?php echo e(!empty($row->consultation) ? 'Change File' : 'Upload'); ?>

                                        </button>

                                        <?php if(!empty($row->consultation)): ?>
                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/view-consultation/' . $row->id)); ?>"
                                                target="_blank" class="btn btn-sm btn-primary viewconsultation-btn">View
                                                Consultation</a>

                                            <a href="<?php echo e(url('dashboard/senior/google-sheet/download-consultation/' . $row->id)); ?>"
                                    ...
                                    <td>
                                        <?php $exeOptions = ['Document Send','Verification Completed']; ?>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function initDatePickers(context = document) {
                const laravelToday =
                    "<?php echo e(\Carbon\Carbon::now('America/New_York')->format('m/d/Y')); ?>";
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/trainer.blade.php ENDPATH**/ ?>