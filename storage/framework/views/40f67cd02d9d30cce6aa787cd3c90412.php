                                ...
                                <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                                    ...
                                    <td colspan="2">
                                        <input type="text" class="form-control remark-autocomplete" data-key="Remark"
                                            rows="6" value="<?php echo e($row->Remark ?? ''); ?>" placeholder="Type remark">
                                    </td>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/junior.blade.php ENDPATH**/ ?>