    ...
    <div class="card-body p-24">
        <div class="table-responsive scroll-sm">
            <table class="table bordered-table sm-table mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $juniorUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($index + 1); ?></td>

                        <td><?php echo e($user->name); ?></td>
                        <td><?php echo e($user->email); ?></td>
                        <td><?php echo e($user->role === 'junior' ? 'IT Recruiter' : $user->role); ?></td>

                        <td class="text-center">
                            <a href="<?php echo e(route('call.reports.alljuniormonthly', $user->id)); ?>"
                                class="btn btn-sm btn-primary">
                                View Monthly
                            </a>
                            <a href="<?php echo e(route('call.reports.alljuniorweekly', $user->id)); ?>"
                                class="btn btn-sm btn-success">
                                View weekly
                            </a>
                            <a href="<?php echo e(route('call.reports.alljuniordaily', $user->id)); ?>"
                                class="btn btn-sm btn-success">
                                View Daily
                            </a>
                        </td>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/reports/alljuniorlist.blade.php ENDPATH**/ ?>