...
<?php $__env->startSection('content'); ?>
    ...
    <div id="pdf">
        <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div id="pdfContent-<?php echo e($index); ?>" class="pt-5 pdf-page"
                        ...
                        <div class="card h-100 border-0 shadow-sm"
                            ...
                            <div class="card-body d-flex justify-content-between align-items-center p-4">
                                ...
                                <div class="d-flex justify-content-center align-items-center"
                                    ...
                                    <iconify-icon icon="mdi:bullseye-arrow"
                                        style="font-size: 34px; color: #0d47a1;"></iconify-icon>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card h-100 border-0 shadow-sm"
                            ...
                            <div class="card-body d-flex justify-content-between align-items-center p-4">
                                ...
                                <div class="d-flex justify-content-center align-items-center"
                                    ...
                                    <iconify-icon icon="fa-solid:trophy"
                                        style="font-size: 34px; color: #6a1b9a;"></iconify-icon>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($t8to9am); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($o8to9am); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($tr8to9am); ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="white-space: nowrap;">09.00AM-10.00AM</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($t9to10am); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($o9to10am); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($tr9to10am); ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="white-space: nowrap;">10.00AM-11.00AM</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($t10to11am); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($o10to11am); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($tr10to11am); ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="white-space: nowrap;">11.00AM-12.00PM</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($t11to12pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($o11to12pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($tr11to12pm); ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="white-space: nowrap;">12.00PM-01.00PM</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($t12to1pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($o12to1pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($tr12to1pm); ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="white-space: nowrap;">01.00PM-02.00PM</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($t1to2pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($o1to2pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($tr1to2pm); ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="white-space: nowrap;">02.00PM-03.00PM</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($t2to3pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($o2to3pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($tr2to3pm); ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="white-space: nowrap;">03.00PM-04.00PM</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($t3to4pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($o3to4pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($tr3to4pm); ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="white-space: nowrap;">04.00PM-05.00PM</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($t4to5pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($o4to5pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($tr4to5pm); ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="white-space: nowrap;">05.00PM-06.00PM</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($t5to6pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($o5to6pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($tr5to6pm); ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="white-space: nowrap;">06.00PM-07.00PM</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($t6to7pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($o6to7pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($tr6to7pm); ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="white-space: nowrap;">07.00PM-08.00PM</td>
                                                <td class="text-center"><span
                                                        class="badge bg-info"><?php echo e($t7to8pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-warning"><?php echo e($o7to8pm); ?></span>
                                                </td>
                                                <td class="text-center"><span
                                                        class="badge bg-success"><?php echo e($tr7to8pm); ?></span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="mt-24">
                                    <div class="d-flex align-items-center gap-1 justify-content-between mb-44">
                                        ...
                                        <div class="position-relative">
                                            <div id="semiCircleGauge-<?php echo e($index); ?>"></div>
                                            <span
                                    ...
                                    <div class="d-flex align-items-center gap-1 justify-content-between mb-44">
                                        ...
                                        <div id="areaChart-<?php echo e($index); ?>"></div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-1 justify-content-between">
                                        ...
                                        <div id="dailyIconBarChart-<?php echo e($index); ?>"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/reports/allreport.blade.php ENDPATH**/ ?>