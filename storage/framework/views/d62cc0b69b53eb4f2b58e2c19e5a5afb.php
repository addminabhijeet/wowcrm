    ...
    <div class="sidebar-menu-area">
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li><a href="<?php echo e(route('google.sheet.juniorvm')); ?>"><i
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li><a href="<?php echo e(route('google.sheet.seniorpaidins')); ?>"><i
                ...
                <ul class="sidebar-submenu">
                    <li><a href="<?php echo e(route('google.sheet.seniorsearch')); ?>"><i
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li><a href="<?php echo e(route('senior.group')); ?>"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>Senior Group</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li><a href="<?php echo e(route('call.reports.preallseniorlist')); ?>"><i
                                class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>(Previous) IT Senior Recruiter
                            Report</a></li>
                </ul>
                <ul class="sidebar-submenu">
                    <li><a href="<?php echo e(route('call.reports.allseniorlist')); ?>"><i
                ...
                <ul class="sidebar-submenu">
                    <li><a href="<?php echo e(route('call.reports.allseniorlist')); ?>"><i
                            ...
                            Report</a></li>
                                ...
                                <ul class="sidebar-submenu">
                    <li><a href="<?php echo e(route('call.reports.neverreached')); ?>"><i
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li><a href="<?php echo e(route('senior.groupmailchart')); ?>"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>Group Report</a></li>
                </ul>
            </li>
            <?php endif; ?>
...
</aside><?php /**PATH C:\xampp\htdocs\wowcrm\resources\views/components/sidebar.blade.php ENDPATH**/ ?>