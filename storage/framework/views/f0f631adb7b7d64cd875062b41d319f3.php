            ...
            <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                ...
                <td>
                    <input type="tel" class="form-control phone-input" data-key="Phone Number"
                        maxlength="14" value="<?php echo e($row->Phone_Number ?? ''); ?>" placeholder="US number" readonly>
                </td>
                ...
                <td class="text-center">
                    ...
                    <button class="btn btn-sm btn-warning transfers-btn" data-id="<?php echo e($row->id); ?>">
        ...
        <script>
            ...
            $(document).ready(function() {
                $('.save-btn').click(function() {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('juniorcandmupdate')); ?>",
                        type: 'POST',
                        data: formData,
                        contentType: false,
                        processData: false,
...
<?php endif; ?>
</div><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/partials/juniorcandm_table.blade.php ENDPATH**/ ?>