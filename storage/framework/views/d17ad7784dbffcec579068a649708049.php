    ...
    <div class="custom-bg">
        <div class="container container--xl">
            <div class="d-flex align-items-center justify-content-between py-24">
                ...
                <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-primary-600 text-sm"> LogIn </a>
            </div>
            ...
            <div class="py-res-120">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 d-lg-block d-none">
                        <img src="<?php echo e(asset('assets/images/coming-soon/coming-soon.png')); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\wowdash\resources\views/comingSoon.blade.php ENDPATH**/ ?>