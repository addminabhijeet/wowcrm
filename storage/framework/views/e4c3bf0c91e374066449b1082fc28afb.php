                                ...
                                <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                                    ...
                                    <td>
                                        <input type="text" class="form-control" data-key="PayeeName"
                                            value="<?php echo e($row->PayeeName ?? ''); ?>" placeholder="Payor Name">
                                    </td>
            ...
            tableBody.addEventListener('click', function(e) {
                if (e.target.matches('.save-btn') || e.target.closest('.save-btn')) {
                    ...
                    if (id === "new") {
                        ...
                        url = "<?php echo e(route('accountantupdate')); ?>";
                        method = "POST";
                        formData.append("id", id);
                    }
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/accountantpaid.blade.php ENDPATH**/ ?>