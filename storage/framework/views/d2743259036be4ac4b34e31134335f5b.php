                ...
                <div class="col-xxl-12">
                    <div class="card radius-12 shadow-none border overflow-hidden">
                        ...
                        <div class="card-body p-24">
                            ...
                            <form action="<?php echo e(route('smtp.update', $smtp->user_id ?? auth()->id())); ?>" method="POST"
                                class="mb-5">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group radius-8">
                                            ...
                                            <input type="text" name="mailer" class="form-control radius-8"
                                                value="<?php echo e(old('mailer', $smtp->mailer ?? 'smtp')); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group radius-8">
                                            ...
                                            <input type="text" name="host" class="form-control radius-8"
                                                value="<?php echo e(old('host', $smtp->host ?? '')); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group radius-8">
                                            ...
                                            <input type="number" name="port" class="form-control radius-8"
                                                value="<?php echo e(old('port', $smtp->port ?? 465)); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group radius-8">
                                            ...
                                            <input type="text" name="encryption" class="form-control radius-8"
                                                value="<?php echo e(old('encryption', $smtp->encryption ?? 'ssl')); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group radius-8">
                                            ...
                                            <input type="email" name="from_address" class="form-control radius-8"
                                                value="<?php echo e(old('from_address', $smtp->from_address ?? '')); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group radius-8">
                                            ...
                                            <input type="file" name="signature_image" id="signatureImage"
                                                accept="image/*" class="form-control radius-8">
                                        </div>
                                        ...
                                        <?php if(!empty($smtp->signature_image)): ?>
                                            <div class="mt-2">
                                                ...
                                                <img src="<?php echo e(asset('storage/' . $smtp->signature_image)); ?>"
                                                    alt="Signature Image" class="img-fluid rounded border"
                ...
                if (testForm.length) {
                    testForm.on('submit', function(e) {
                        ...
                        try {
                            ...
                            $.ajax({
                                url: "<?php echo e(route('smtp.test', $smtp->id)); ?>",
                                method: "POST",
                                data: {
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/smtp/edit.blade.php ENDPATH**/ ?>