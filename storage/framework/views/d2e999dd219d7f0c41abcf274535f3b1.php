<?php
$title='View Senior Support Associate';
$role = auth()->user()->role ?? '';
if($role === 'admin'){
...
<div class="row gy-4">
    <div class="col-lg-4">
        <div class="user-grid-card position-relative border radius-16 overflow-hidden bg-base h-100" style="padding-top: 100px;">
            <img src="<?php echo e($user->image ? asset('assets/images/user-grid/' . $user->image) : asset('assets/images/users/user1.png')); ?>" alt="" class="w-100 object-fit-cover">
            <div class="pb-24 ms-16 mb-24 me-16  mt--100">
                <div class="text-center border border-top-0 border-start-0 border-end-0">
                    <img src="<?php echo e($user->image ? asset('assets/images/user-grid/' . $user->image) : asset('assets/images/users/user1.png')); ?>" alt="" class="border br-white border-width-2-px w-200-px h-200-px rounded-circle object-fit-cover">
                ...
                <div class="mt-24">
                    ...
                    <ul>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">: <?php echo e($user->phone); ?></span>
                        </li>
                        <li class="d-flex align-items-center gap-1 mb-12">
                            <span class="w-30 text-md fw-semibold text-primary-light"> Role</span>
                            <span class="w-70 text-secondary-light fw-medium">
                                : <?php echo e($user->role === 'support' ? 'Senior Support Associate' : $user->role); ?>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">: <?php echo e($user->gender === 'Support' ? 'Senior Support Associate' : $user->gender); ?></span>
                        </li>
    ...
    <div class="col-lg-8">
        <div class="card h-100">
            <div class="card-body p-24">
                ...
                <form action="<?php echo e(route('users.support.update', $user->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-24 mt-16">
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <img id="imagePreview"
                                            src="<?php echo e($user->image ? asset('storage/user_images/' . $user->image) : asset('assets/images/user-grid/user-grid-img14.png')); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control radius-8"
                                            value="<?php echo e(old('name', $user->name)); ?>" placeholder="Enter Full Name" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <input type="number" name="phone" id="phone" value="<?php echo e(old('phone', $user->phone)); ?>"
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="role" id="role" class="form-control radius-8 form-select" required>
                                            ...
                                            <option value="junior" <?php echo e($user->role == 'junior' ? 'selected' : ''); ?>>IT Recruiter</option>
                                            <option value="support" <?php echo e($user->role == 'support' ? 'selected' : ''); ?>>Senior Support Associate</option>
                                            <option value="admin" <?php echo e($user->role == 'admin' ? 'selected' : ''); ?>>Admin</option>
                                            <option value="candidate" <?php echo e($user->role == 'customer' ? 'selected' : ''); ?>>Customer</option>
                                            <option value="accountant" <?php echo e($user->role == 'accountant' ? 'selected' : ''); ?>>Support</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="gender" id="gender" class="form-control radius-8 form-select" required>
                                            <option value="" disabled <?php echo e(!$user->gender ? 'selected' : ''); ?>>Select gender</option>
                                            <option value="Accountant" <?php echo e($user->gender == 'Accountant' ? 'selected' : ''); ?>>Support</option>
                                            <option value="Admin" <?php echo e($user->gender == 'Admin' ? 'selected' : ''); ?>>Admin</option>
                                            <option value="Candidate" <?php echo e($user->gender == 'Candidate' ? 'selected' : ''); ?>>Candidate</option>
                                            <option value="Junior" <?php echo e($user->gender == 'Junior' ? 'selected' : ''); ?>>IT Recruiter</option>
                                            <option value="Support" <?php echo e($user->gender == 'Support' ? 'selected' : ''); ?>>Senior Support Associate</option>
                                            <option value="Trainer" <?php echo e($user->gender == 'Trainer' ? 'selected' : ''); ?>>Trainer</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="pills-notification" role="tabpanel">
                            <div class="form-switch switch-primary py-12 px-16 border radius-8 position-relative mb-16">
                                <div class="d-flex align-items-center gap-3 justify-content-between">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="status" name="status" value="1" <?php echo e($user->status ? 'checked' : ''); ?>>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/user/supportedit.blade.php ENDPATH**/ ?>