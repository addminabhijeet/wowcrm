    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function attachSaveHandler(btn) {
            btn.addEventListener("click", function() {
                ...
                const url = id === 'new' ? '/dashboard/senior/google-sheet/store' : `/dashboard/senior/google-sheet/update/${id}`;
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        async function uploadResume(td, file, button) {
            ...
            let url = `/dashboard/senior/google-sheet/pdfstore`;
            let method = "POST";
            if (recordId !== "new") {
                url = `/dashboard/senior/google-sheet/pdfupdate/${recordId}`;
                formData.append("_method", "PATCH");
                method = "POST";
