            ...
            <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div>
                        ...
                        <h6 class="mb-0"><?php echo e($users->count()); ?></h6>
                    </div>
            ...
            <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div>
                        ...
                        <h6 class="mb-0"><?php echo e($users->where('role', 'junior')->count()); ?></h6>
                    </div>
            ...
            <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div>
                        ...
                        <h6 class="mb-0"><?php echo e($users->where('role', 'senior')->count()); ?></h6>
                    </div>
            ...
            <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div>
                        ...
                        <h6 class="mb-0"><?php echo e($users->where('role', 'accountant')->count()); ?></h6>
                    </div>
            ...
            <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div>
                        ...
                        <h6 class="mb-0"><?php echo e($users->where('role', 'trainer')->count()); ?></h6>
                    </div>
                    <div class="w-50-px h-50-px bg-cyan rounded-circle d-flex justify-content-center align-items-center">
            ...
            <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div>
                        ...
                        <h6 class="mb-0"><?php echo e($users->where('role', 'admin')->count()); ?></h6>
                    </div>
                    <div class="w-50-px h-50-px bg-success-main rounded-circle d-flex justify-content-center align-items-center">
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wowcrm\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>