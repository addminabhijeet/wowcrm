                    ...
                    <tr id="row-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>">
                        ...
                        <td>
                            <input type="text" class="form-control amount-input" data-key="Amount"
                                value="<?php echo e($row->Amount ?? ''); ?>" placeholder="Amount">
                        </td>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wowcrm\resources\views/database/senior.blade.php ENDPATH**/ ?>