                    ...
                    <div class="d-flex flex-wrap align-items-center gap-4">
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-3">
                            <button type="button" class="position-relative">
                                <img src="<?php echo e(asset('assets/images/lang-flag.png')); ?>" alt="image" class="w-32-px h-32-px object-fit-cover rounded-circle">
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/componentspage/badges.blade.php ENDPATH**/ ?>