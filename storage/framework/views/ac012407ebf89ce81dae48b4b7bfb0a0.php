        ...
        <div class="col-lg-12"><!-- full width column -->
            <div class="card h-100">
                <div class="card-body p-24">
                    ...
                    <form action="<?php echo e(route('users.accountant.update', $candidate->id)); ?>" method="POST"
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <input type="text" id="name" name="name"
                                                    ...
                                                    value="<?php echo e(old('name', $candidate->Name)); ?>"
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <input type="text" id="phone" name="phone"
                                                    ...
                                                    value="<?php echo e(old('phone', $candidate->Phone_Number)); ?>"
                                                ...
                                                <select id="time_zone" name="time_zone"
                                                    ...
                                                    <?php $__currentLoopData = $timezoneOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($option); ?>"
                                                            <?php echo e(old('time_zone', $candidate->Time_Zone ?? '') === $option ? 'selected' : ''); ?>>
                                                            <?php echo e($option); ?>
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <input type="email" name="email"
                                                    ...
                                                    value="<?php echo e(old('email', $candidate->Email_Address)); ?>"
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <input type="text" name="Location" class="form-control radius-8"
                                                    value="<?php echo e(old('Location', $candidate->Location)); ?>"
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    saveBtn.addEventListener("click", function() {
                                        ...
                                        axios.post("<?php echo e(route('candidate.saveProfile', $candidate->id)); ?>", data)
                                    ...
                                    <div class="col-12 d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <select name="relocation" id="relocation" class="form-control radius-8"
                                                    ...
                                                    <?php $__currentLoopData = $relOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($option); ?>"
                                                            <?php echo e(old('relocation', $candidate->Relocation ?? '') === $option ? 'selected' : ''); ?>>
                                                            <?php echo e($option); ?>
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <input type="date" name="graduation" id="graduation"
                                                    ...
                                                    value="<?php echo e(old('graduation', $candidate->Graduation_Date ?? '')); ?>"
                                                    required>
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <select name="immigration" id="immigration" class="form-select radius-8"
                                                    ...
                                                    <?php $__currentLoopData = $immOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($option); ?>"
                                                            <?php echo e(old('immigration', $candidate->Immigration ?? '') === $option ? 'selected' : ''); ?>>
                                                            <?php echo e($option); ?>
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <select name="course" id="course" class="form-select radius-8"
                                                    ...
                                                    <?php $__currentLoopData = $courseOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($option); ?>"
                                                            <?php echo e(old('course', $candidate->Course ?? '') === $option ? 'selected' : ''); ?>>
                                                            <?php echo e($option); ?>
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <select name="qualification" id="qualification"
                                                    ...
                                                    <?php $__currentLoopData = $qualificationOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($option); ?>"
                                                            <?php echo e(old('qualification', $candidate->Qualification ?? '') == $option ? 'selected' : ''); ?>>
                                                            <?php echo e($option); ?>
                                            ...
                                            <textarea name="edu_data" id="edu_data" class="d-none">
                                                <?php echo e(old('edu_data', $candidate->edu_data ?? '')); ?>
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    saveBtn.addEventListener("click", function() {
                                        ...
                                        axios.post("<?php echo e(route('candidate.saveEdu', $candidate->id)); ?>", {
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="amount" id="amount"
                                                        class="form-control radius-8"
                                                        value="<?php echo e(old('amount', $candidate->Amount ?? '')); ?>"
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <input type="date" name="PaymentDate" id="PaymentDate"
                                                    class="form-control radius-8"
                                                    value="<?php echo e(old('PaymentDate', $candidate->PaymentDate ?? '')); ?>"
                                                    required>
                                            </div>
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <input type="text" name="TranId" id="TranId"
                                                    class="form-control radius-8"
                                                    value="<?php echo e(old('TranId', $candidate->TranId ?? '')); ?>"
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <input type="text" name="TranRef" id="TranRef"
                                                    class="form-control radius-8"
                                                    value="<?php echo e(old('TranRef', $candidate->TranRef ?? '')); ?>"
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <input type="text" name="PaymentMethod" id="PaymentMethod"
                                                    class="form-control radius-8"
                                                    value="<?php echo e(old('PaymentMethod', $candidate->PaymentMethod ?? '')); ?>"
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <input type="text" name="PayeeName" id="PayeeName"
                                                    class="form-control radius-8"
                                                    value="<?php echo e(old('PayeeName', $candidate->PayeeName ?? '')); ?>"
                                            ...
                                            <textarea name="payment_data" id="payment_data" class="d-none">
                                                <?php echo e(old('payment_data', $candidate->payment_data ?? '')); ?>
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    saveBtn.addEventListener("click", function() {
                                        ...
                                        axios.post("<?php echo e(route('candidate.savePayment', $candidate->id)); ?>", {
                            ...
                            <div class="tab-pane fade" id="pills-change-passwork" role="tabpanel">
                                ...
                                <div class="mb-20">
                                    ...
                                    <textarea name="First_Follow_Up_Remarks" id="First_Follow_Up_Remarks" class="form-control radius-8"
                                        placeholder="Enter 1st follow up remarks" required readonly><?php echo e(old('First_Follow_Up_Remarks', $candidate->First_Follow_Up_Remarks ?? '')); ?></textarea>
                                </div>
                                ...
                                <div class="mb-20">
                                    ...
                                    <textarea name="Remark" id="Remark" class="form-control radius-8" placeholder="Enter Remark" required readonly><?php echo e(old('Remark', $candidate->Remark ?? '')); ?></textarea>
                                </div>
                                ...
                                <div class="mb-20">
                                    ...
                                    <textarea name="followups" id="followups" class="d-none"><?php echo e(old('followups', $candidate->followup ?? '')); ?></textarea>
                                </div>
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        ...
                                        addRemarkBtn.addEventListener("click", function() {
                                            ...
                                            axios.post("<?php echo e(route('candidate.saveFollowups', $candidate->id)); ?>", {
                            ...
                            <div class="tab-pane fade" id="pills-resume" role="tabpanel">
                                ...
                                <?php if(!empty($candidate->resume)): ?>
                                    ...
                                    box-shadow:0 3px 10px rgba(0,0,0,0.12);">
                                        <iframe
                                            src="<?php echo e(url('dashboard/senior/google-sheet/view-resume/' . $candidate->id)); ?>"
                                ...
                                <?php if(!empty($candidate->updateresume)): ?>
                                    <div
                                        style="width:100%; margin-bottom:30px; height:85vh;
                                background:#ffffff; border-radius:10px; overflow:hidden;
                                box-shadow:0 3px 10px rgba(0,0,0,0.12);">
                                        <iframe
                                            src="<?php echo e(url('dashboard/senior/google-sheet/view-updateresume/' . $candidate->id)); ?>"
                                            style="width:100%; height:100%; border:none;" allowfullscreen>
                                        </iframe>
                                    </div>
                                <?php else: ?>
                            ...
                            <div class="tab-pane fade" id="pills-senddocument" role="tabpanel"
                                ...
                                <?php if(!empty($candidate->acceptance)): ?>
                                    <div
                                        style="width:100%; margin-bottom:30px; height:85vh;
                                background:#ffffff; border-radius:10px; overflow:hidden;
                                box-shadow:0 3px 10px rgba(0,0,0,0.12);">
                                        <iframe
                                            src="<?php echo e(url('dashboard/senior/google-sheet/view-acceptance/' . $candidate->id)); ?>"
                                            style="width:100%; height:100%; border:none;" allowfullscreen>
                                        </iframe>
                                    </div>
                                <?php else: ?>
                                ...
                                <?php if(!empty($candidate->consultation)): ?>
                                    <div
                                        style="width:100%; margin-bottom:30px; height:85vh;
                                background:#ffffff; border-radius:10px; overflow:hidden;
                                box-shadow:0 3px 10px rgba(0,0,0,0.12);">
                                        <iframe
                                            src="<?php echo e(url('dashboard/senior/google-sheet/view-consultation/' . $candidate->id)); ?>"
                                            style="width:100%; height:100%; border:none;" allowfullscreen>
                                        </iframe>
                                    </div>
                                <?php else: ?>
                                ...
                                <?php if(!empty($candidate->delivery)): ?>
                                    <div
                                        style="width:100%; margin-bottom:30px; height:85vh;
                                background:#ffffff; border-radius:10px; overflow:hidden;
                                box-shadow:0 3px 10px rgba(0,0,0,0.12);">
                                        <iframe
                                            src="<?php echo e(url('dashboard/senior/google-sheet/view-delivery/' . $candidate->id)); ?>"
                                            style="width:100%; height:100%; border:none;" allowfullscreen>
                                        </iframe>
                                    </div>
                                <?php else: ?>
                                ...
                                <?php if(!empty($candidate->payment)): ?>
                                    <div
                                        style="width:100%; margin-bottom:30px; height:85vh;
                                background:#ffffff; border-radius:10px; overflow:hidden;
                                box-shadow:0 3px 10px rgba(0,0,0,0.12);">
                                        <iframe
                                            src="<?php echo e(url('dashboard/senior/google-sheet/view-payment/' . $candidate->id)); ?>"
                                            style="width:100%; height:100%; border:none;" allowfullscreen>
                                        </iframe>
                                    </div>
                                <?php else: ?>
                            ...
                            <div class="tab-pane fade" id="pills-signeddocument" role="tabpanel">
                                ...
                                <!-- Resume Viewer -->
                                <?php if(!empty($candidate->signeddocument)): ?>
                                    <div class="w-100" style="height: 85vh;">
                                        <iframe
                                            src="<?php echo e(url('dashboard/senior/google-sheet/view-signeddocument/' . $candidate->id)); ?>"
                                            style="width: 100%; height: 100%; border: none;" allowfullscreen>
                                        </iframe>
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center gap-3 justify-content-between">
                                        ...
                                        <input class="form-check-input" type="checkbox" id="status" name="status"
                                            value="1" <?php echo e($candidate->status ? 'checked' : ''); ?>>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/candidate/details.blade.php ENDPATH**/ ?>