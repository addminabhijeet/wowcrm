...
<script>
    $(document).ready(function() {
        ...
        function fetchTable(search = '', page = 1, junior_user = '', row_id = '') {
            $.ajax({
                url: "<?php echo e(route('google.sheet.seniormodcandmfollow')); ?>",
                type: 'GET',
                data: {
                    search,
                    page,
        ...
        const showSuggestions = debounce(function() {
            ...
            $.ajax({
                url: "<?php echo e(route('seniormodcandmfollow.suggestions')); ?>",
                type: 'GET',
                data: {
                    query,
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/database/seniormodcandmfollow.blade.php ENDPATH**/ ?>