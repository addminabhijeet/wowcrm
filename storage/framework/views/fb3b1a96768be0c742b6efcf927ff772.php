                                ...
                                <div>
                                    ...
                                    <div class="upload-image-wrapper">
                                        <div class="uploaded-img d-none position-relative h-160-px w-100 border input-form-light radius-8 overflow-hidden border-dashed bg-neutral-50">
                                            ...
                                            <img id="uploaded-img__preview" class="w-100 h-100 object-fit-cover" src="<?php echo e(asset('assets/images/user.png')); ?>" alt="image">
                                        </div>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/norloxsolutionscrm.com/wowcrm/resources/views/blog/addBlog.blade.php ENDPATH**/ ?>