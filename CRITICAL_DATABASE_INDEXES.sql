...
ALTER TABLE users ADD INDEX IF NOT EXISTS idx_role_deleted (role, is_deleted);
...
ALTER TABLE user_timer_logs ADD INDEX IF NOT EXISTS idx_user_id (user_id);
ALTER TABLE user_timer_logs ADD INDEX IF NOT EXISTS idx_user_created (user_id, created_at DESC);

-- For pause status checks
ALTER TABLE user_timer_pause ADD INDEX IF NOT EXISTS idx_user_id_pause (user_id);
ALTER TABLE user_timer_pause ADD INDEX IF NOT EXISTS idx_user_created_pause (user_id, created_at DESC);
...
ALTER TABLE notifications ADD INDEX IF NOT EXISTS idx_created_desc (created_at DESC);

-- ============================================================================
-- 4. GOOGLE SHEET DATA INDEXES (frequently searched)
-- ============================================================================
-- Critical for candidate searches
ALTER TABLE google_sheet_data ADD INDEX IF NOT EXISTS idx_created_by (created_by);
ALTER TABLE google_sheet_data ADD INDEX IF NOT EXISTS idx_created_by_date (created_by, `Date` DESC);

-- For search functionality
ALTER TABLE google_sheet_data ADD INDEX IF NOT EXISTS idx_name_search (Name);
ALTER TABLE google_sheet_data ADD INDEX IF NOT EXISTS idx_email_search (Email_Address);
ALTER TABLE google_sheet_data ADD INDEX IF NOT EXISTS idx_phone_search (Phone_Number);

-- For common filters
ALTER TABLE google_sheet_data ADD INDEX IF NOT EXISTS idx_exe_remarks (Exe_Remarks);
ALTER TABLE google_sheet_data ADD INDEX IF NOT EXISTS idx_updated_at (updated_at DESC);

-- ============================================================================
-- 5. CHAT TABLES INDEXES (for message queries)
-- ============================================================================
ALTER TABLE chat ADD INDEX IF NOT EXISTS idx_sender_receiver (sender_id, receiver_id);
ALTER TABLE chat ADD INDEX IF NOT EXISTS idx_recipient_unread (receiver_id, is_read, created_at DESC);
ALTER TABLE chat ADD INDEX IF NOT EXISTS idx_sender_recipient (sender_id, receiver_id, created_at DESC);
ALTER TABLE chat ADD INDEX IF NOT EXISTS idx_created_desc (created_at DESC);

-- ============================================================================
-- 6. OTHER IMPORTANT TABLES
-- ============================================================================
-- Payments
ALTER TABLE payments ADD INDEX IF NOT EXISTS idx_user_id (user_id);
ALTER TABLE payments ADD INDEX IF NOT EXISTS idx_created_at (created_at DESC);

-- Attendance
ALTER TABLE attendance ADD INDEX IF NOT EXISTS idx_user_id_date (user_id, attendance_date);
