                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('target.allaccountantmonthly', $user->id) }}" class="btn btn-sm btn-primary">
                                View Monthly
                            </a>

                            <a href="{{ route('target.allaccountantdaily', $user->id) }}" class="btn btn-sm btn-success">
                                View Daily
                            </a>
                        </td>
