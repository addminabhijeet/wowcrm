                ...
                <div class="mt-24">
                    ...
                    <ul>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">: {{ $user->designation === 'associate' ? 'Support Associate' : $user->designation}}</span>
                        </li>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="designation" id="designation" class="form-control radius-8 form-select" required>
                                            ...
                                            <option value="Associate" {{ $user->designation == 'Associate' ? 'selected' : '' }}>Support Associate</option>
