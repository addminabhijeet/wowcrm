                    ...
                    <ul>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">
                                : {{ $user->role === 'support' ? 'Senior Support Associate' : $user->role }}
                            </span>

                        </li>
                        <li class="d-flex align-items-center gap-1 mb-12">
                            <span class="w-30 text-md fw-semibold text-primary-light"> Designation</span>
                            <span class="w-70 text-secondary-light fw-medium">: {{ $user->designation === 'Support' ? 'Senior Support Associate' : $user->designation}}</span>
                        </li>
    ...
    <div class="col-lg-8">
        <div class="card h-100">
            <div class="card-body p-24">
                ...
                <form action="{{ route('users.support.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="role" id="role" class="form-control radius-8 form-select" required>
                                            ...
                                            <option value="support" {{ $user->role == 'support' ? 'selected' : '' }}>Senior Support Associate</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-20">
                                        ...
                                        <select name="designation" id="designation" class="form-control radius-8 form-select" required>
                                            ...
                                            <option value="Support" {{ $user->designation == 'Support' ? 'selected' : '' }}>Senior Support Associate</option>
