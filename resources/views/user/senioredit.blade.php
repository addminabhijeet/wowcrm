                ...
                <div class="mt-24">
                    ...
                    <ul>
                        ...
                        <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <span class="w-70 text-secondary-light fw-medium">: {{ $user->gender === 'Senior' ? 'IT Senior Recruiter' : $user->gender}}</span>
                        </li>
                            ...
                            <div class="mb-24 mt-16">
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <img id="imagePreview"
                                            src="{{ $user->image ? asset($user->image) : asset('assets/images/user-grid/user-grid-img14.png') }}">
                                    </div>
                                </div>
                            </div>
