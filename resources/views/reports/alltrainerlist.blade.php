...
@php
$title='All Trainer Call Report';
$subTitle = 'All Trainer Call Report';
$script = '<script>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('call.reports.alltrainermonthly', $user->id) }}" class="btn btn-sm btn-primary">
                                View Monthly
                            </a>

                            <a href="{{ route('call.reports.alltrainerdaily', $user->id) }}" class="btn btn-sm btn-success">
                                View Daily
                            </a>
                        </td>
