                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('call.reports.allseniormonthly', $user->id) }}" class="btn btn-sm btn-primary">
                                View Monthly
                            </a>

                            <a href="{{ route('call.reports.allseniordaily', $user->id) }}" class="btn btn-sm btn-success">
                                View Daily
                            </a>
                        </td>
