...
@section('content')
    ...
    <div id="pdfContent">
        @foreach ($reports as $index => $report)
            ...
            <div id="pdfContent-{{ $index }}" class="pdf-page row row-cols-xxl-4 row-cols-md-4 row-cols-sm-2 row-cols-1 g-4" style="page-break-after: always; padding-bottom: 50px;">
                <div class="col">
                                        ...
                                        <table class="table table-hover table-bordered align-middle mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay8 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay8 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>09</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay9 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay9 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay9 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>10</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay10 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay10 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay10 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>11</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay11 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay11 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay11 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>12</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay12 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay12 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay12 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>13</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay13 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay13 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay13 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>14</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay14 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay14 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay14 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>15</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay15 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay15 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay15 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>16</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay16 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay16 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay16 }}</span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                        ...
                                        <table class="table table-hover table-bordered align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay17 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay17 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>18</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay18 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay18 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay18 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>19</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay19 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay19 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay19 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>20</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay20 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay20 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay20 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>21</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay21 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay21 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay21 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>22</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay22 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay22 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay22 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>23</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay23 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay23 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay23 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>24</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay24 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay24 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay24 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>25</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay25 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay25 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay25 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>26</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay26 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay26 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay26 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>27</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay27 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay27 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay27 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>28</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay28 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay28 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay28 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>29</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay29 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay29 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay29 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>30</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay30 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay30 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay30 }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>31</td>
                                                    <td class="text-center"><span class="badge bg-info">{{ $tDay31 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-warning">{{ $oDay31 }}</span></td>
                                                    <td class="text-center"><span class="badge bg-success">{{ $trDay31 }}</span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
    ...
    <script>
        ...
        `;
                ...
                // ✅ Build the file name from the selected month -> Monthly_Report_<month>.pdf
                const selectedMonthInput = document.querySelector('input[name="selected_month"]');
                const selectedMonth = selectedMonthInput ? selectedMonthInput.value : '';
                let pdfFileName = 'monthly-report.pdf';
                if (selectedMonth) {
                    pdfFileName = `Monthly_Report_${selectedMonth}.pdf`;
                }
