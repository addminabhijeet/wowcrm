                        ...
                        <div class="col-md-2">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    ...
                                    <h4 class="fw-bold text-dark mb-0 fs-6">{{ $MtotalCalls }}</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    ...
                                    <h4 class="fw-bold text-dark mb-0 fs-6">{{ $MfollowUpCalls }}</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    ...
                                    <h4 class="fw-bold text-dark mb-0 fs-6">{{ $McalledAndMailedCalls }}</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    ...
                                    <h4 class="fw-bold text-dark mb-0 fs-6">{{ $MselffollowupCalls }}</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    ...
                                    <h4 class="fw-bold text-dark mb-0 fs-6">{{ $MtransferedfollowUpCalls }}</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                ...
                                <div>
                                    ...
                                    <h4 class="fw-bold text-dark mb-0 fs-6">{{ $MreadyToPaidCalls }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
