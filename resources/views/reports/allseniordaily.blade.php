                ...
                <div class="card h-100 border-0 shadow-sm radius-12">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
                            ...
                            <form method="GET"
                                action="{{ route('call.reports.allseniordaily', ['userId' => request()->route('userId')]) }}"
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-2">
                                <div class="card border-0 shadow-sm radius-12 text-center p-3 h-100">
                                    ...
                                    <div>
                                        <small class="text-muted d-block">Ready To Pay Calls</small>
                            ...
                            <table class="table table-hover table-bordered align-middle mb-0">
                                <thead class="table-primary">
                                    <tr>
                                        ...
                                        <th class="fw-semibold text-center">Follow Up Count</th>
