            ...
            <div class="col-xxl-3 col-md-6 user-grid-card">
                <div class="position-relative border radius-16 overflow-hidden" style="padding-top: 30px;">
                    ...
                    <div class="ps-16 pb-16 pe-16 text-center mt--50">
                        <img src="{{ !empty($timer['image']) && file_exists(public_path('assets/images/user-grid/' . $timer['image'])) ? asset('assets/images/user-grid/' . $timer['image']) : asset('assets/images/user-grid/default-user.png') }}" class="border br-white border-width-2-px w-100-px h-100-px rounded-circle object-fit-cover" alt="">
