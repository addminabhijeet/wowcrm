    ...
    <div class="sidebar-menu-area">
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li><a href="{{ route('google.sheet.accountantcon') }}"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>Ready To Paid</a></li>
                </ul>
                <ul class="sidebar-submenu">
                    <li><a href="{{ route('google.sheet.accountant') }}"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>Payment Completed</a></li>
                </ul>
                <ul class="sidebar-submenu">
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li><a href="{{ route('candidate.accountant') }}"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>Database</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li><a href="{{ route('call.reports.allaccountantdaily', Auth::id()) }}"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>Daily Personal Report</a></li>
                </ul>
                <ul class="sidebar-submenu">
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li><a href="{{ route('dashboard.support') }}"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i>Dashboard</a></li>
                </ul>
            </li>
