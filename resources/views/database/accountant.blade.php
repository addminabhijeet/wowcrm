        ...
        function addBlankRow() {
            ...
            colKeys.forEach(k => {
                if (['Exe Remarks', 'Immigration', 'Relocation', '1st Follow Up Remarks', 'Course', 'Time Zone', 'Qualification'].includes(k)) {
                    ...
                    cells += `<td><input type="text" class="form-control name-input" data-key="${k}" placeholder="Reference Number"><span class="small-hint"></span></td>`;
                } else if (k === 'Payment Method') {
                    cells += `<td><input type="text" class="form-control name-input" data-key="${k}" placeholder="Payment Method"><span class="small-hint"></span></td>`;
...
">
    ...
    ">
        ...
        <!-- SINGLE IFRAME CARD -->
        <div style="background:#fff; padding:18px; border-radius:12px; max-width: 520px;   
        ...
        <div style="background:#fff; padding:18px; border-radius:12px; max-width: 620px;   
            box-shadow:0 4px 18px rgba(0,0,0,0.08); border:1px solid #eee;">
