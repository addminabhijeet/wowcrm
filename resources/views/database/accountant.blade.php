        ...
        function addBlankRow() {
            ...
            colKeys.forEach(k => {
                ...
                // THESE FIELDS WERE MISSING BECAUSE FIRST ROW DID NOT PROVIDE data-key
                    ...
                    cells += `<td><input type="text" class="form-control" data-key="${k}" placeholder="Payment Method"><span class="small-hint"></span></td>`;
                } else if (k === 'Payee Name') {
                    cells += `<td><input type="text" class="form-control" data-key="${k}" placeholder="Payee Name"><span class="small-hint"></span></td>`;
