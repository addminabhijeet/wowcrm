                ...
                <tbody id="sheet-table-body">
                    ...
                    <tr id="row-{{ $row->id }}" data-id="{{ $row->id }}">
                        ...
                        <td>
                            ...
                            @if(!empty($row->resume))
                            <a href="{{ url('dashboard/trainer/google-sheet/view-resume/'.$row->id) }}" target="_blank" class="btn btn-sm btn-primary view-btn">View PDF</a>
                            <a href="{{ url('dashboard/trainer/google-sheet/download-resume/'.$row->id) }}" class="btn btn-sm btn-secondary download-btn">Download</a>
                            @else
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        tableBody.addEventListener('click', function(e) {
            if (e.target.matches('.save-btn') || e.target.closest('.save-btn')) {
                ...
                let url, method;
                if (id === "new") {
                    url = "{{ route('trainerstore') }}";
                    method = "POST";
                } else {
                    url = "{{ route('trainerupdate') }}";
                    method = "POST";
                        ...
                        if (data.success) {
                            ...
                            if (id === "new") {
                                ...
                                if (viewBtn && data.resume_path) {
                                    viewBtn.href = `/dashboard/trainer/google-sheet/view-resume/${data.id}`;
                                    viewBtn.classList.remove('d-none');
                                }

                                if (downloadBtn && data.resume_path) {
                                    downloadBtn.href = `/dashboard/trainer/google-sheet/download-resume/${data.id}`;
