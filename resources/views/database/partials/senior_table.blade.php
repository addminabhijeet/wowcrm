                                    ...
                                    <tr id="row-{{ $row->id }}" data-id="{{ $row->id }}">
                                        ...
                                        <td>
                                            <input type="tel" class="form-control phone-input"
                                                data-key="Phone Number" maxlength="14"
                                                value="{{ $row->Phone_Number ?? '' }}" placeholder="US number">
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @if (!empty($row->resume))
                                                <a href="{{ url('dashboard/junior/google-sheet/view-resume/' . $row->id) }}"
                                                    target="_blank" class="btn btn-sm btn-primary view-btn">View
                                                    File</a>
                                            ...
                                            @else
                                                <a href="#" target="_blank"
                                                    class="btn btn-sm btn-primary view-btn d-none">View
                                                    File</a>
                                                <a href="#" download
                                        ...
                                        {{-- Remark --}}
                                        <td>
                                            <input type="text" class="form-control remark-autocomplete"
